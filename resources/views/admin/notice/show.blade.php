                ...
                <div class="portlet-body form">
                    <div style="padding:20px;">
                        ...
                        <?php 
                            ...
                            if ($notices->type=='B'){
                                echo "<h4>Year : ".$notices->year."</h4>";
                                echo "<h4>Session : ".$notices->sessionname->name."</h4>";
                                echo "<h4>Institute : ".$notices->institutename->name."</h4>";
                                echo "<h4>Course : ".$notices->coursename->name."</h4>";
                                echo "<h4>Batch : ".$notices->batchname->name."</h4>";
                            }
