                                    ...
                                    @foreach ($batch_slots as $value)
                                        @if ($value['slot_type'])
                                            ...
                                            @if ($value['slot_type'] == '3')
                                                <th style="vertical-align: middle !important;text-align: center;border-left-width: 1px;border-bottom-width: 1px;" width="15%" id="id_break" rowspan="{{$count_rows}}">{{ $value->slot->slot_name }} <br> {{ $value['start_time'] }} TO {{ $value['end_time'] }} </th>
                                            @else
