...
<table class="result-data" border="0" width="900px" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td width="35%" align="center"><span style="font-family:Verdana; font-size:15px; font-weight:bold;"><u><b>Hypertension & Research Centre, Rangpur</b></u></span></td>
...
<table class="result-data" border="0" width="900px" align="center" cellpadding="2" cellspacing="0">
    <tr>
        <td colspan="2">
            ...
            <a href="http://genesisedu.info/" style="font-size:20px;">For Result Please Visit: www.htncr.com</a>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td width="25%" align="center">Coordinator<br>HTNCR</td>
    </tr>
</table>
