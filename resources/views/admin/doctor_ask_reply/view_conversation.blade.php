                ...
                <div class="portlet-body form">
                    ...
                    @foreach($doctor_ask_replies as $key => $doctor_ask_reply)
                        <tr style="background-color: {{ ($doctor_ask_reply->user_id!=0)?'#FFFFFF':'#E9E9E9' }} ;">
                            ...
                            <td style="width:30%;">{{($doctor_ask_reply->user_id !=0 )? $doctor_ask_reply->user->name : $doctor_ask_reply->doctor->name.' ( '.$doctor_ask_reply->doctor_ask->doctor_course->reg_no.' ) ' }} : </td> 
