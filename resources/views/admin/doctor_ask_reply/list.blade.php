                    ...
                    <table class="table table-striped table-bordered table-hover datatable">
                        ...
                        @foreach($doctor_ask_replies as $doctor_ask_reply)
                            <tr>
                                ...
                                <td>{{ $doctor_ask_reply->doctor_id ? $doctor_ask_reply->doctor->name : '' }}</td>
                                <td>{{ $doctor_ask_reply->user_id ? $doctor_ask_reply->user->name : '' }}</td>
                                <td>{{ $doctor_ask_reply->message_by ? $doctor_ask_reply->message_by : ''  }}</td>
                                <td>{{ $doctor_ask_reply->message }}</td>
                                <td>{{ $doctor_ask_reply->doctor_ask_id ? $doctor_ask_reply->doctor_ask->video->name : '' }}</td>
