                    ...
                    <!-- BEGIN FORM-->
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        <input type="text" name="room_name" required value="{{ $room->room_name }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        <input type="text" name="Location" required value="{{ $room->Location }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        <input type="text" name="floor" required value="{{ $room->floor }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        <input type="number" name="capacity" required value="{{ $room->capacity }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    {!! Form::select('status', ['1' => 'Active','0' => 'InActive'], $room->status,['class'=>'form-control']) !!}<i></i>
                                </div>
                            </div>
                    </div>
