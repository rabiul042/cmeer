                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-icon right">
                                    <input type="text" name="title" required value="{{ $lecture_sheet->title }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-icon right">
                                    <textarea id="description" name="description" required class="form-control">{{ $lecture_sheet->description  }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-icon right">
                                        ...
                                        {!! Form::select('institute_id',$institutes, $lecture_sheet->institute_id ? $lecture_sheet->institute_id :'' ,['class'=>'form-control','required'=>'required','id'=>'institute_id']) !!}<i></i>
                        ...
                        <div class="courses">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('course_id',$courses, isset($lecture_sheet->course_id) ? $lecture_sheet->course_id : '',['class'=>'form-control','required'=>'required','id'=>'course_id']) !!}<i></i>
                                </div>
                            ...
                            @if($institute_type==1)
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {!! Form::select('faculty_id',$faculties, isset($lecture_sheet->faculty_id) ? $lecture_sheet->faculty_id : '' ,['class'=>'form-control','id'=>'faculty_id']) !!}<i></i>
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="subjects">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('subject_id',$subjects, isset($lecture_sheet->subject_id) ? $lecture_sheet->subject_id : '' ,['class'=>'form-control','id'=>'subject_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="batches">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('batch_id',$batches, isset($lecture_sheet->batch_id) ? $lecture_sheet->batch_id : '' ,['class'=>'form-control','required'=>'required','id'=>'batch_id']) !!}<i></i>
                                </div>
                            </div>
                        </div> -->
                        <div class="topics">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {!! Form::select('topic_id',$topics, isset($lecture_sheet->topic_id) ? $lecture_sheet->topic_id : '' ,['class'=>'form-control','required'=>'required','id'=>'topic_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
