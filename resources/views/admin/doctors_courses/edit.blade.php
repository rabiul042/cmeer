   ...
   <div class="portlet">
    ...
    <div class="portlet-body form">
     ...
     <div class="form-body">
      ...
      <div class="form-group">
       <label class="col-md-3 control-label">Payment Status (<i class="fa fa-asterisk ipd-star" style="font-size:9px;"></i>) </label>
       <div class="col-md-3">
        {!! Form::select('payment_status', [''=>'Select Payment Status','No Payment' => 'No Payment','In Progress' => 'In Progress', 'Completed'=>'Completed', 'Requested'=>'Requested'], $doctor_course->payment_status,['class'=>'form-control','required'=>'required']) !!}<i></i>
       </div>
      </div>
