                                            ...
                                            <tr>
                                                ...
                                                @foreach($online_lecture_link as $keys=>$links)
                                                    @foreach($links as $key=>$link)
                                                        <!--<a href="{{ $link->lecture_address }}" target="_blank" class="btn btn-xs btn-primary">{{ $link->name }}</a><br>-->
                                                            <span class="btn btn-xs btn-primary" data-toggle='modal' data-target='#myModal_{{$link->id}}'>{{ $link->name }}</span>
