    ...
    <div class="row">
                            ...
                            <div class="portlet">
                                <div class="portlet-body">
                                  <b><ul class="page-breadcrumb">
                                      ...
                                      <li> <i class="fa fa-angle-right"></i> <a href="/lecture-sheet">Lecture Sheet</a></li>
        ...
        <div class="sidebar">
            @foreach($lecture_sheets as $lecture_sheet)
                <a class="@php echo (Request::segment(1)=='lecture-details' && Request::segment(2)==$lecture_sheet->id )?'active':''  @endphp" href="{{url('lecture-details/'.$lecture_sheet->id)}}">{{ $lecture_sheet->title}}</a>				
            @endforeach
        </div>
        </div>
		</div>
