    ...
    <div class="row">
        ...
        <div class="col-md-9 col-md-offset-0">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:#7fc9f6; color: #FFFFFF;"><h3>Complain Box</h3></div>
                ...
                <div class="panel-body">
                    ...
                    @endif
                                    ...
                                    <table class="table table-striped table-bordered table-hover datatable">
                                        ...
                                        @foreach ($complain_info as $complain)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="complain-details/{{$complain->id}}" class="btn btn-xs btn-primary">
                                                    View Reply</a>
                                                </td>
                                            </tr>
                            ...
                            <div class="col-md-12 col-md-offset-0" style="">
                            <hr><h4 style="color:orange"><b>New Complain</b></h4>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="input-icon right">
                                                Type Complain : <br>
                                                <textarea name="description" value="" class="form-control" required></textarea>
                                            </div>
                                        </div>
                                    </div>
