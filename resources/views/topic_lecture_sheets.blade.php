                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="input-icon right">
                                    ...
                                    {!! Form::select('topic_id',$lecture_sheet_topics, $topic->id ,['class'=>'form-control','required'=>'required','id'=>'topic_id']) !!}<i></i>
                                </div>
                            </div>
                        </div>
                                            ...
                                            @foreach($lecture_sheet_batch as $lecture_sheet)
                                                <div class="col-md-12">
                                                    ...
                                                    <div>{!! substr(strip_tags($lecture_sheet->description),0,100) !!}<br>
                                                        <a href="{{ url('lecture-details/'.$lecture_sheet->id ) }}">Continue reading...</a></div>
                                                </div>
                                            @endforeach
