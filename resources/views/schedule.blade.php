                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover datatable">
                                        ...
                                        @foreach ($doc_info->doctorcourses as $k=>$value)
                                            @if(isset($value->schedule->id) && $value->is_trash=='0')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url("doc-profile/print-batch-schedule/".$value->schedule->id) }}" class='btn btn-xs btn-primary' target='_blank'>View Schedule</a>
                                                    </td>
                                                </tr>
                                            @endif
                                        @endforeach
