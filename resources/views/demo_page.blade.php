...
<div class="container">
  <form action="{{url('register-first-step-submit')}}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="row">
      <div class="col-md-2">
      ...
      <div class="col-md-8">
        ...
        <div class="row mx-0">
          ...
          <div class="col-md-8 col-lg-9">
            ...
            <input type="text" class="form-control" name="bmdc_no" placeholder="BMDC Registration Number. EX:A012345"
              required>
          ...
          <div class="col-md-8 col-lg-9">
            <input type="email" class="form-control" name="email" placeholder="yourmail@gmail.com" required>
          </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input class="save" type="submit" value="Save & Next" name="save">
  </form>
</div>
