...
class LectureSheetLink extends Model
{
    //protected $table = 'lecture_sheet_links';
    protected $table = 'lecture_sheet_batch';

    public function topics()
    {
        //return $this->belongsToMany('App\LectureSheet');
        return $this->hasMany('App\LectureSheetTopics','lecture_sheet_batch_id','id');
    }
    
    public function batch_lecture_sheets()
    {
        //return $this->belongsToMany('App\LectureSheet');
        return $this->hasMany('App\LectureSheetBatchPost','lecture_sheet_batch_id','id');
    }
