...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $title = 'Tempore Admin : Individual List';
    ...
    public function metabase_users_list()
    {
        ...
        $data['title'] = 'Tempore Admin : Metabase Dashboard';
    ...
    public function metabase_users_list_q()
    {
        ...
        $data['title'] = 'Tempore Admin : Individual List';
    ...
    public function organization_users($id)
    {
        ...
        $title = 'Tempore Admin : Users of Organization';
    ...
    public function create()
    {
        ...
        $title = 'Tempore Admin : Individual Create';
    ...
    public function show($id)
    {
        ...
        $data['title'] = 'Tempore Admin : Individual Detail';
