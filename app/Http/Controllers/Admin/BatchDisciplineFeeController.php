...
class BatchDisciplineFeeController extends Controller
{
    ...
    public function create()
    {
       // $user=Subjects::find(Auth::id());
        ...
        $data['batches'] = Batches::where('fee_type','Discipline')->pluck('name', 'id');
    ...
    public function edit($id)
    {
       /* $user=Subjects::find(Auth::id());
        ...
        $data['batches'] = Batches::where(['course_id' => $batch_discipline_fee->batch->course->id, 'fee_type'=>'Discipline'])->pluck('name', 'id');
