...
class LectureSheetPost extends Model
{
    protected $table = 'lecture_sheet_post';

    public function lecture_sheet_links()
    {
        return $this->belongsToMany('App\LectureSheetLink',['year','session_id','institute_id','course_id','topic_id'], ['year','session_id','institute_id','course_id','topic_id']);
    }
